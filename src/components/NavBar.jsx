...
export default function NavBar({ children, ...attr }) {
    ...
    return (
        <div className="h-screen flex overflow-hidden bg-black" style={{backgroundColor: currTheme.backdrop}}>
            <Transition.Root show={sidebarOpen} as={Fragment}>
                ...
                >
                    ...
                    >
                        <div className="relative flex-1 flex flex-col max-w-min pt-5 pb-4 bg-indigo-700" style={{backgroundColor: currTheme.backdrop}}>
                            <Transition.Child
                                as={Fragment}
                            ...
                            <div className="mt-5 flex-1 h-0 overflow-y-auto" >
                                <nav className="px-2 space-y-1">
                                    {navigation.map((item) => (
                                        ...
                                        >
                                            <item.icon className="mr-4 h-6 w-6 text-indigo-300" aria-hidden="true" style={{color: currTheme.fontColor}} />
                                            {item.name}
                                        </Link>
                                    ))}
                                </nav>
            ...
            <div className="flex flex-col w-0 flex-1 overflow-hidden">
                <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow" style={{backgroundColor: currTheme.secColor}}>
                    <button
                        type="button"
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <img
                            className="h-8 w-auto"
                            src="https://myanimelist.net/img/pc/ownlist/logo_mal.png"
                            alt="Workflow"
                        />
                    </div>
                </div>
